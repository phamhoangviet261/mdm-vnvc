  ...
  return (
    <Fragment>
      <Container ref={slider}>
        <Image ref={slider1} className='slider1' src='/banner/slider2.jpg' alt='slider1'/>
        <Image ref={slider2} className='slider2' src='/banner/slider3.jpg' alt='slider2'/>
        <Image ref={slider3} className='slider3' src='/banner/slider4.jpg' alt='slider3'/>
      </Container>
      <Temp>
          <PageContainer>
